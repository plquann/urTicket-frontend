...
export default function NewLarge() {
    return (
        <div className="new-large">
            <h1 className="new-large__title">Latest News</h1>

            <div className="new-large__wrapper">
                <div className="new-large__wrapper__thumbnails">
                    <img className="w-full h-full" src={newContent.imgUrl} alt="thumbnails" />
                </div>
                <div className="new-large__wrapper__content">
                    <div className="new-large__wrapper__content__category mb-4">
                        <a href="#0">NEWS</a>
                        <a href="#0">TRENDING</a>
                    ...
                    <div className="new-large__wrapper__content__info flex flex-wrap justify-between items-center mt-8">

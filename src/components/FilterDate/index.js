...
export default function FilterDate() {
    ...
    return (
        <div className=" w-1/6 h-auto p-8 rounded mx-auto mt-3" style={{ backgroundColor: "#032055" }}>
            <p className="text-lg font-semibold uppercase border-b border-solid pb-4 mb-4" style={{ borderColor: "#1f2b72" }}>Date</p>
            <div className="mb-3">
